...
const REPORT_OPTIONS: ReportOption[] = [
  {
    id: "scam",
    label: "Scam or Fraud",
    description: "Suspicious activity, fake products, or phishing attempts",
    icon: AlertCircle
  },
  {
    id: "inappropriate",
    label: "Inappropriate Content",
    description: "Offensive, adult, or prohibited items",
    icon: Flag
  },
  {
    id: "misleading",
    label: "Fake or Misleading",
    description: "False descriptions, fake photos, or counterfeit items",
    icon: X
  },
  {
    id: "safety",
    label: "Safety Concern",
    description: "Dangerous, illegal, or stolen items",
    icon: Shield
  },
  {
    id: "duplicate",
  ...
  {
    id: "wrong-category",
    label: "Wrong Category or Price",
    description: "Listed in incorrect category or unrealistic pricing",
    icon: DollarSign
  },
  {
    id: "fake-account",
    label: "Fake or Spam Account",
    description: "Suspicious seller account or bot activity",
    icon: User
  },
  {
    id: "prohibited",
    label: "Prohibited Item",
    description: "Items that violate our policies or local laws",
    icon: Package
  }
];
...
export function ReportSheet({ open, onOpenChange }: ReportSheetProps) {
  ...
  const handleSubmit = () => {
    ...
    // En una app real, aquí se enviaría el reporte
    console.log("Report submitted:", { reasons: selectedReasons, details: additionalDetails });
          ...
          <div className="sticky top-0 bg-white border-b z-10">
            <div className="flex items-center h-14 px-4">
              ...
              <div className="flex-1 text-center pr-10">
                <h2 className="text-sm text-muted-foreground uppercase tracking-wide">Product Page</h2>
              </div>
            </div>
            ...
            <div className="px-4 pb-4 pt-2">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="text-lg">Report Listing</h3>
              </div>
